...
const experiences = [
  ...
  },
  {
    ...
    description: "Ingreso al área de Tecnología de la Información de SEDIPRO UNT. Participo en proyectos internos aplicando enfoques ágiles y, por encargo de la presidencia, desarrollé un sistema semiautomático en Python para la generación masiva de certificados.",
  ...
  },
  {
    ...
    description: "Coordinador TI en SEDITALKS, evento de SEDIPRO UNT. Gestioné la infraestructura tecnológica y colideré el desarrollo de un Sistema de Asistencia con códigos QR en Python y OpenCV, integrado en tiempo real con Google Sheets.",
